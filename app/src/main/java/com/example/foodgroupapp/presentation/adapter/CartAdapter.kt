...
class CartAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CartAdapter.FoodViewHolder {
    ...
    override fun onBindViewHolder(holder: CartAdapter.FoodViewHolder, position: Int) {
